...
void rtc_tie_test(void *pvParameter){
	int cnt=0;
	time_t now = 0;
...
void app_rtc_time(){
//	gpio_ini();
    if ( xTaskCreate(&rtc_tie_test, "rtc_time_task", 1024 * 5, NULL, 5, NULL) != pdPASS ) {
        printf("create rtc_time_task failed\r\n");
    }
}
