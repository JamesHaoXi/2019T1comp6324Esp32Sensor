...
#define EXAMPLE_WIFI_SSID "HHH"//CONFIG_WIFI_SSID
#define EXAMPLE_WIFI_PASS "FFF"//CONFIG_WIFI_PASSWORD
...
void azure_task(void *pvParameter)
{
    ...
    wifi_connection = true;//set blue led to identify the wifi connected

    iothub_client_sample_mqtt_run();

    wifi_connection = false;//wifi or cloud connection error
    vTaskDelete(NULL);
}
